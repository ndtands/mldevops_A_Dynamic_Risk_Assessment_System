...
def check_new_files(ingested, folder_path):

    input_dir = os.path.join(os.getcwd(), folder_path)
...
def check_drift(new_df, prod_deployment_path):
    ...
    if not model_drift:
        ...
        outdated_packages_list()
        reporting.score_model(test_data_csv_path, cfm_path, prod_deployment_path)
        request_api(
...
if __name__ == "__main__":
    ...
    ingested = read_ingest(output_folder_path)
